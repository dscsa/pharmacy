...
function export_cp_remove_item($order_item) {
  echo "export_cp_remove_item ".print_r($order_item, true);
}

function export_cp_add_more_items($order_item) {
  echo "export_cp_add_more_items ".print_r($order_item, true);
}
function export_cp_remove_more_items($order_item) {
  echo "export_cp_remove_more_items ".print_r($order_item, true);
}
