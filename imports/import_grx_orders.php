...
function import_grx_orders() {
  ...
  $orders = $mssql->run("
    ...
    SELECT
      ...
      CAST(add_date as datetime) as order_date_added,
      CAST(csom.ship_date as datetime) as order_date_dispensed,
      CAST(ship.ship_date as datetime) as order_date_shipped,
      CAST(chg_date as datetime) as order_date_changed
    FROM csom
