...
function import_cp_orders() {
  ...
  $orders = $mssql->run("
    ...
    WHERE
      ...
      AND (csom.ship_date IS NOT NULL OR csom.chg_date > @today - ".DAYS_OF_ORDERS_TO_IMPORT.") -- Only recent orders to cut down on the import time (30-60s as of 2021-01-08).
