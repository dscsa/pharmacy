...
function createCalendarEvent(event) {
    ...
    if (!calendar) {
        console.error('createCalendarEvent ERROR NO CALENDAR WITH CAL_ID', event)
        return;
    }
...
function removeCalendarEvents(opts) {
    ...
    if (opts.events.length)
        console.info('removeCalendarEvents', opts)
}
...
function modifyCalendarEvents(opts) {
    ...
    console.info('modifyCalendarEvents', opts)
}
...
function searchCalendarEvents(opts) {
    ...
    if (events.length)
        console.info('searchCalendarEvents', start, stop, (matches ? matches.length : events.length) + ' of ' + events.length + ' of the events match the following:', opts, haystacks)
